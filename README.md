...
| <a name="input_cis_controls_enabled"></a> [cis\_controls\_enabled](#input\_cis\_controls\_enabled) | n/a | <pre>object({<br>    root_account_usage   = bool<br>    root_account_usage_2 = bool<br>    root_account_usage_3 = bool<br>  })</pre> | <pre>{<br>  "root_account_usage": false,<br>  "root_account_usage_2": false,<br>  "root_account_usage_3": false<br>}</pre> | no |

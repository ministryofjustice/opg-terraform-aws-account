...
| <a name="input_cis_1_2_foundation_control_3_1_enabled"></a> [cis\_1\_2\_foundation\_control\_3\_1\_enabled](#input\_cis\_1\_2\_foundation\_control\_3\_1\_enabled) | When true, creates a metric filter and alarm for CIS.3.1. When false, sets standard control to disabled. | `bool` | `true` | no |
...
| <a name="input_iam_access_analyser_unused_access_enabled"></a> [iam\_access\_analyser\_unused\_access\_enabled](#input\_iam\_access\_analyser\_unused\_access\_enabled) | Should the Unused Access Analyser for IAM Access Analyser be enabled | `bool` | `false` | no |

module "aws_cost_notifier" {
  ...
  source                    = "git@github.com:ministryofjustice/opg-aws-cost-notifier.git?ref=v1.34.7"
...
module "aws_health_notifier" {
  ...
  source                    = "git@github.com:ministryofjustice/opg-aws-health-notifier.git?ref=v1.29.7"
  account_name              = var.account_name

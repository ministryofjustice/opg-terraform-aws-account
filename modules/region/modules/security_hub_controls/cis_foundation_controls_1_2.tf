resource "aws_securityhub_standards_subscription" "cis_1_2" {
  count         = var.security_hub_config.cis_1_2_subscription_enabled ? 1 : 0
...
resource "aws_securityhub_standards_control" "cis_1_14_ensure_hardware_mfa_is_enabled_for_the_root_account" {
  ...
  control_status        = var.security_hub_config.cis_1_2_foundation_control_1_14_enabled ? "ENABLED" : "DISABLED"
  disabled_reason       = var.security_hub_config.cis_1_2_foundation_control_1_14_enabled ? null : "See ADR https://docs.opg.service.justice.gov.uk/documentation/adrs/adr-004.html#adr-004-no-hardware-mfa-key-for-root-account"
}
locals {
  ...
  cis_foundation_control_3_10_custom_enabled = var.security_hub_config.cis_1_2_foundation_control_3_10_custom_filter == "" ? false : true
  cis_controls = {
    cis_3_1_unauthorised_api_calls = {
      ...
      actions_enabled       = var.security_hub_config.cis_1_2_foundation_control_3_1_enabled
      control_status        = var.security_hub_config.cis_1_2_foundation_control_3_1_enabled ? "ENABLED" : "DISABLED"
    ...
    cis_3_4_iam_policy_changes = {
      ...
      actions_enabled       = var.security_hub_config.cis_1_2_foundation_control_3_4_enabled
      control_status        = var.security_hub_config.cis_1_2_foundation_control_3_4_enabled ? "ENABLED" : "DISABLED"
    ...
    cis_3_8_s3_bucket_policy_changes = {
      ...
      actions_enabled       = var.security_hub_config.cis_1_2_foundation_control_3_8_enabled
      control_status        = var.security_hub_config.cis_1_2_foundation_control_3_8_enabled ? "ENABLED" : "DISABLED"
    ...
    cis_3_10_security_group_changes = {
      ...
      actions_enabled       = var.security_hub_config.cis_1_2_foundation_control_3_10_enabled || local.cis_foundation_control_3_10_custom_enabled ? true : false
      control_status        = var.security_hub_config.cis_1_2_foundation_control_3_10_enabled && !local.cis_foundation_control_3_10_custom_enabled ? "ENABLED" : "DISABLED"
      pattern               = local.cis_foundation_control_3_10_custom_enabled ? var.security_hub_config.cis_1_2_foundation_control_3_10_custom_filter : "{($.eventName=AuthorizeSecurityGroupIngress) || ($.eventName=AuthorizeSecurityGroupEgress) || ($.eventName=RevokeSecurityGroupIngress) || ($.eventName=RevokeSecurityGroupEgress) || ($.eventName=CreateSecurityGroup) || ($.eventName=DeleteSecurityGroup)}"
      alarm_description     = "aws config configuration changes count"
      alarm_threshold       = 1
    }
    cis_3_11_changes_to_network_access_control_lists = {
      ...
      actions_enabled       = var.security_hub_config.cis_1_2_foundation_control_3_11_enabled
      control_status        = var.security_hub_config.cis_1_2_foundation_control_3_11_enabled ? "ENABLED" : "DISABLED"
    ...
    cis_3_12_changes_to_network_gateways = {
      ...
      actions_enabled       = var.security_hub_config.cis_1_2_foundation_control_3_12_enabled
      control_status        = var.security_hub_config.cis_1_2_foundation_control_3_12_enabled ? "ENABLED" : "DISABLED"
    ...
    cis_3_13_changes_to_route_tables = {
      ...
      actions_enabled       = var.security_hub_config.cis_1_2_foundation_control_3_13_enabled
      control_status        = var.security_hub_config.cis_1_2_foundation_control_3_13_enabled ? "ENABLED" : "DISABLED"
    ...
    cis_3_14_vpc_changes = {
      ...
      actions_enabled       = var.security_hub_config.cis_1_2_foundation_control_3_14_enabled
      control_status        = var.security_hub_config.cis_1_2_foundation_control_3_14_enabled ? "ENABLED" : "DISABLED"
...
resource "aws_cloudwatch_log_metric_filter" "toggled_control" {
  for_each       = local.create_cloudtrail_alarms ? merge(local.cis_controls, local.cis_metrics_only) : {}
  name           = each.value.metric_name
  pattern        = each.value.pattern
  log_group_name = var.security_hub_config.aws_cloudwatch_log_group_cloudtrail_name

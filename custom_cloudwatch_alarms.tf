...
module "custom_cloudwatch_alarms" {
  ...
  custom_alarms_breakglass_assume_role_alarm_enabled  = var.custom_alarms_breakglass_assume_role_alarm_enabled
  custom_alarms_data_access_assume_role_alarm_enabled = var.custom_alarms_data_access_assume_role_alarm_enabled
  providers = {
    aws = aws
  }
}
